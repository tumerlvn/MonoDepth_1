...
model = IDisc.build(json.load(open('/home/tamerlan/Masters/thesis/idisc/configs/kitti/kitti_r101.json'))) # depth
# model = IDisc.build(json.load(open('/home/tamerlan/Masters/thesis/idisc/configs/nyunorm/nyunorm_swinl.json'))) # normals

model.load_pretrained("/home/tamerlan/Masters/thesis/idisc/idisc/models/checkpoints/kitti_resnet101.pt") # depth
...
old_size = image_resized.size
image_resized = image_resized.resize([1000, 400], resample=Image.LANCZOS)
...
Image.fromarray(image_array).resize(old_size, resample=Image.BICUBIC).save(save_path)