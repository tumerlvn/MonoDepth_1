...
## path
path = edict()
path.data_path = "/home/tamerlan/Masters/thesis/MonoDTR/data/KITTI/object/training" # used in visualDet3D/data/.../dataset
path.test_path = "/home/tamerlan/Masters/thesis/MonoDTR/data/KITTI/object/testing" # used in visualDet3D/data/.../dataset
